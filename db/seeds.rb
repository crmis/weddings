...
Addition.create!([
                   ...
                   {booking_id: 1, extra_id: 3},
                   {booking_id: 1, extra_id: 4},
                   {booking_id: 1, extra_id: 5},
                 ])
Enquiry.create!([
...
Viewing.create!([
                  {start_time: "2015-08-01 09:00:00", end_time: "2015-08-01 13:59:00", length: 5, room_id: 1, user_id: 3}
                ])
Booking.create!([
                  {start_time: "2015-08-02 09:00:00", end_time: "2015-08-02 13:59:00", length: 5, room_id: 1, user_id: 3}
                ])
